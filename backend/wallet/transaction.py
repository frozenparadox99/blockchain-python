...
class Transaction:
    ...
    def from_json(transaction_json):
        """
        Deserialize the transaction's json rep back into a transaction instance
        """
...
def main():
    ...
    print(f'transactipon : {transaction.__dict__}')

    transaction_json = transaction.to_json()

    restored_transaction = Transaction.from_json(transaction_json)
    print(f'\nrestored_transaction : {restored_transaction.__dict__}')
