...
class Wallet:
    ...
    def calculate_balance(blockchain,address):
        ...
        The balance is found by adding the outpyt values that belong to the addres since the most recent transaction
        by that address
        """
        ...
        for block in blockchain.chain:
            for transaction in block.data:
                if transaction['input']['address'] == address:
                    # Any time the address conducts a new transact it resets its balance
